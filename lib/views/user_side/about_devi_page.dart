              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Image.network(data.heroImage.isNotEmpty ? data.heroImage : 'https://via.placeholder.com/700x450', fit: BoxFit.cover, errorBuilder: (c,e,s) => Container(height: 400, color: Colors.white24)),
                  ),
                ),
              ],
            ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Image.network(data.quoteImage.isNotEmpty ? data.quoteImage : 'https://via.placeholder.com/600x600', height: 500, fit: BoxFit.cover, errorBuilder: (c,e,s) => Container(color: Colors.black26)),
                ),
              ],
            ),
          ),
