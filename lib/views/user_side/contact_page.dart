...
class _ContactPageState extends State<ContactPage> {
  ...
  String get _messageCountText {
    int count = _messageController.text.length;
    return "$count / 1000";
  }
  ...
  Future<void> _submitForm(HomePageController controller) async {
    ...
    if (!_robotChecked) {
      setState(() => _errorText = AppLocalizations.of(context)!.verifyNotRobot);
      return;
    }
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      child: SiteElevatedButton(
        ...
        backgroundColor: isSent ? Colors.green : (isSubmitting || isSent ? primaryColor.withOpacity(0.6) : primaryColor),
