...
class UserRamKatha extends StatefulWidget {
  final HomePageController controller;
  const UserRamKatha({super.key, required this.controller});

  @override
  State<UserRamKatha> createState() => _UserRamKathaState();
}

class _UserRamKathaState extends State<UserRamKatha> {
  ...
  Widget build(BuildContext context) {
    ...
    final kathaData = widget.controller.ramKatha;
    final lang = Localizations.localeOf(context).languageCode;
    final double screenWidth = MediaQuery.of(context).size.width;
    final bool isMobile = screenWidth < 1100;

    return VisibilityDetector(
      key: const Key('user-ram-katha'),
