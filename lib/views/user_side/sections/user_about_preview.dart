...
class UserAboutPreview extends StatefulWidget {
  final HomePageController controller;
  const UserAboutPreview({super.key, required this.controller});

  @override
  State<UserAboutPreview> createState() => _UserAboutPreviewState();
}

class _UserAboutPreviewState extends State<UserAboutPreview> {
  ...
  Widget build(BuildContext context) {
    ...
    final about = widget.controller.aboutSection;

    return VisibilityDetector(
      key: const Key('user-about-preview'),
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: isMobile ? MediaQuery.of(context).size.width * 0.85 * 1.25 : 500,
                      decoration: BoxDecoration(
