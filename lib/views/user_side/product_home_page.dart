...
class ProductHomePage extends StatelessWidget {
            ...
            child: ConstrainedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 1,
                    child: config.bannerUrl.isNotEmpty ? ClipRRect(borderRadius: BorderRadius.circular(16), child: Image.network(config.bannerUrl, height: 400, fit: BoxFit.cover, errorBuilder: (c, e, s) => Container(height: 400, color: Colors.white10, child: const Icon(Icons.storefront, color: Colors.white, size: 100)))) : Container(height: 400, decoration: BoxDecoration(borderRadius: BorderRadius.circular(16), color: Colors.white10), child: const Icon(Icons.storefront, color: Colors.white, size: 100)),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildFeaturedProductsSection(BuildContext context, ProductController prod) => _buildSection(context, 'Featured Sacred Items', prod.featuredProductsStream);
  Widget _buildLatestProductsSection(BuildContext context, ProductController prod) => _buildSection(context, 'Latest Arrivals', prod.latestProductsStream);
  Widget _buildPopularProductsSection(BuildContext context, ProductController prod) => _buildSection(context, 'Most Popular', prod.popularProductsStream);
