      ...
      child: ConstrainedBox(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return _wishlistProductCard(context, wishlist[index], prod, cart);
          },
        ),
      ),
    );
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () => prod.toggleLike(product.id),
                    child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: AppTypography.bodyStyle(context, fontWeight: FontWeight.bold, fontSize: 18, color: teal),
                ),
